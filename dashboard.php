...
<html>
  <head>
    ...
    <title> Barangay Information Management System | Dashboard </title>
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="index.html" class="navbar-brand d-none d-sm-inline-block">
                  <div class="brand-text d-none d-lg-inline-block"><span>Barangay </span><strong> IMS</strong></div>
                  <div class="brand-text d-none d-sm-inline-block d-lg-none"><strong>BMIS</strong></div></a>
        ...
        <div class="content-inner">
              ...
              <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><a href="#" class="text-dark"><span>For Assignment</span></a>
                      <div class="progress">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><a href="#" class="text-dark"><span>Assigned</span></a>
                      <div class="progress">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><a href="#"  class="text-dark"><span>In Progress</span></a>
                      <div class="progress">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><a href="#" class="text-dark"><span>Resolved</span></a>
                      <div class="progress">
              ...
              <div class="col-lg-6">
                  <div class="articles card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h2 class="h3">Incident Management Desk </h2>
                    ...
                    <div class="card-body no-padding">
                      <div class="item d-flex align-items-center">
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              <tr>
                                <th scope="row">IM000123</th>
                                <td>Resolved</td>
                                <td><?php echo date('Y-M-d');?></td>
                                <td>Philip Adrian Reyes</td>
                              </tr>
                              <tr>
                                <th scope="row">IM000123</th>
                                <td>Resolved</td>
                ...
                <div class="col-lg-6">
                  <div class="articles card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h2 class="h3"> Service Request Desk   </h2>
                      <div class="badge badge-rounded bg-green">4 New       </div>
                    </div>
                    <div class="card-body no-padding">
                      <div class="item d-flex align-items-center">
          ...
          <footer class="main-footer">
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6">
                  <p>CMIT Technical Services &copy; <?php echo date('Y')?></p>
                </div>
